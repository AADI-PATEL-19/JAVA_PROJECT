...
public class CombineProject{
        ...
        public  static int payment(int bill , String iD , String accepterId){
            ...
            if(temp==null){
                ...
                if(temp.balance<bill){
                    System.out.println("You have not enough money to pay.Check Your Balance.");
        ...
        one.setData("AadyCinema", 9242592425L, "aadycinema@gmail.com", 70000700007777L, 92425, 0,"aadycinema.okaadybank");
